...
function Term_condition() {
  return (
    <div className="w-4/5 m-auto">
      <h1 className="text-4xl font-semibold text-center my-8">Terms & Conditions</h1>
      <p className="text-lg mb-8 ">
        These Terms and Conditions, along with privacy policy or other terms
        (“Terms”) constitute a binding agreement by and between feastic services
        pvt ltd, ( “Website Owner” or “we” or “us” or “our”) and you (“you” or
        “your”) and relate to your use of our website, goods (as applicable) or
        services (as applicable) (collectively, “Services”). By using our
        website and availing the Services, you agree that you have read and
        accepted these Terms (including the Privacy Policy). We reserve the
        right to modify these Terms at any time and without assigning any
        reason. It is your responsibility to periodically review these Terms to
        stay informed of updates.
      </p>
      <h1 className="mt-4 mb-2 text-lg">The use of this website or availing of our Services is subject to the following terms of use:</h1>
      <ul className="mb-8 text-lg list-disc list-outside pl-10 space-y-2">
        <li>
        ...
        <li>
          ...
          subject to the exclusive jurisdiction of the courts in GURGAON,
          Haryana
        </li>
        <li>
