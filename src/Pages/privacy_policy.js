...
function privacy_policy() {
  return (
    <div className='w-4/5 m-auto'>
        ...
        <br></br>
        feastic services pvt ltd may change this Policy periodically and we urge you to check this page for the latest version of the Policy in order to keep yourself updated.
        </p>
        

        <div className='my-4'>
            <h1 className='text-2xl'>What data is being collected</h1>
            <p className='my-2'>
            We may collect the following information from you:
            </p>
            <ul className='list-outside pl-4 list-disc space-y-2'>
                <li>Name</li>
        ...
        <div className='my-4'>
            <h1 className='text-2xl'>Who do we share your data with</h1>
            <ul className='list-outside pl-4 list-disc space-y-2'>
        ...
        <div className='my-4'>
            ...
            <br></br>
            Withdrawal of your Consent - You can choose not to provide your data, at any time while availing our goods or services or otherwise withdraw your consent provided to us earlier, in writing to our email ID: hello@pulseandpills.com. In the event you choose to not provide or later withdraw your consent, we may not be able to provide you our services or goods. Please note that these rights are subject to our compliance with applicable laws.</p>
        </div>

        <div  className='my-4'>
            <h1  className='text-2xl'>How long will we retain your information or data?</h1>
        ...
        <div className='my-4'>
            <h1 className='text-2xl'>Data Security</h1>
        ...
        <div className='my-4'>
            <h1 className='text-2xl'>Queries/ Grievance Officer</h1>
